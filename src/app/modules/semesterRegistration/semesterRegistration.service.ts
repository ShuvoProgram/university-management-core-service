...
import { Course, OfferedCousre, Prisma, SemesterRegistration, SemesterRegistrationStatus, StudentEnrolledCourseStatus, StudentSemesterRegistration, StudentSemesterRegistrationCourse } from "@prisma/client";
...
const getMySemesterRegCouses = async (
    ...
    const offeredCourse = await prisma.offeredCousre.findMany({
        where: {
            semesterRegistration: {
                id: semesterRegistration.id
            },
